...
import 'package:incognito_music/APIs/spotify_api.dart';
...
class _TopChartsState extends State<TopCharts> with AutomaticKeepAliveClientMixin<TopCharts>{
  final ValueNotifier<bool> localFetchFinished = ValueNotifier<bool>(false);
  @override
            ...
            children: [
              ValueListenableBuilder(
                ...
                builder: (BuildContext context, Box box, Widget? widget) {
                  return TopPage(
                    type: box.get('region', defaultValue: 'Vietnam').toString(),
                  );
                },
              ),
              // TopPage(type: 'local'),
...
Future<List> getChartDetails(String accessToken, String type) async {
  ...
  final String localPlaylistId = ConstantCodes.localChartCodes.containsKey(type)
      ...
      : ConstantCodes.localChartCodes['Vietnam']!;
