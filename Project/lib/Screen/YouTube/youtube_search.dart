...
import 'package:incognito_music/CustomWidgets/search_bar.dart';
...
import 'package:incognito_music/Screen/YouTube/youtube_artist.dart';
...
class YouTubeSearchPage extends StatefulWidget {
  ...
  const YouTubeSearchPage(
      {super.key, required this.query, this.autofocus = false});
