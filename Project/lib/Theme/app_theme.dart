...
class AppTheme {
  ...
  static ThemeData lightTheme({
    ...
    return ThemeData(
        ...
        iconTheme:
            IconThemeData(color: Colors.grey[800], opacity: 1.0, size: 24.0),
  ...
  static ThemeData darkTheme({required BuildContext context}) {
    return ThemeData(
        ...
        inputDecorationTheme: InputDecorationTheme(
            focusedBorder: UnderlineInputBorder(
                borderSide: BorderSide(
                    width: 1.5, color: currentTheme.currentColor()))),
        listTileTheme: ListTileThemeData(
            shape: RoundedRectangleBorder(
                borderRadius: BorderRadius.circular(7.0))),
        ...
        progressIndicatorTheme: const ProgressIndicatorThemeData()
            .copyWith(color: currentTheme.currentColor()),
        iconTheme:
            const IconThemeData(color: Colors.white, opacity: 1.0, size: 24.0),
        indicatorColor: currentTheme.currentColor(),
        colorScheme: Theme.of(context).colorScheme.copyWith(
